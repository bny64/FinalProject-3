	...
	<div class="container">
		<div class="logo">
			<span class="avatar"><img
				src="<%=request.getContextPath()%>/img/logo.png"></span>
		</div>
...
.amazing h3:before {
	...
	width: 100%;
	content: '';
	background: url(<%=request.getContextPath()%>/img/line.png) no-repeat;
	display: block;
	position: absolute;
	left: 30px;
	top: 15px;
...
.details-top li {
	list-style-image: url(<%=request.getContextPath()%>/img/icon3.png);
...
i.twter {
	width: 107px;
	height: 107px;
	background: url(<%=request.getContextPath()%>/img/img-sprite.png)
		no-repeat -3px -90px;
	float: left;
	vertical-align: middle;
}
...
.footer h4 {
	...
	font-weight: 300;
	text-transform: uppercase;
	background: url(<%=request.getContextPath()%>/img/line1.png) no-repeat
		center;
	margin-bottom: 1em;
}
...
i.comts {
	...
	height: 13px;
	display: inline-block;
	background: url(<%=request.getContextPath()%>/img/comts.png")
		no-repeat 0px 0px;
	vertical-align: middle;
	margin-right: 12px;
}
...
i.adm {
	...
	height: 15px;
	display: inline-block;
	background: url(<%=request.getContextPath()%>/img/imzs.png") no-repeat
		-85px 1px;
	vertical-align: middle;
	margin-right: 12px;
}
...
ul.social-ic li  span {
	background: url(<%=request.getContextPath()%>/img/lik.png) no-repeat
		-0px 0px;
	width: 36px;
	height: 36px;
	display: block;
...
i.tag {
	...
	height: 15px;
	display: inline-block;
	background: url("<%=request.getContextPath()%>/img/tag.png") no-repeat
		1px 1px;
	vertical-align: middle;
	margin-right: 12px;
}
...
i.tick {
	...
	height: 39px;
	display: inline-block;
	background: url("<%=request.getContextPath()%>/img/suc.png") no-repeat
		0px 2px;
	vertical-align: middle;
	margin-right: 12px;
}
...
@media ( max-width :768px) {
	...
	.head-nav span.menu:before {
		content: url(<%=request.getContextPath()%>/img/menu.png);
		color: #FFF;
		text-align: right;
		cursor: pointer;
	}
